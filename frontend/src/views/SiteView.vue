        ...
        <div class="card card-compact bg-base-100 p-4 w-64 shadow-xl">
          <div class="card-body">
            ...
            <ul class="steps steps-vertical">
              ...
              <li class="step step-accent font-bold">提交(需审核)</li>
            </ul>
          </div>
        </div>
      </div>
    ...
    <div class="flex w-full h-full items-center justify-center">
      <div
        ...
        <div class="flex justify-between w-full">
          ...
          <button class="btn btn-sm btn-primary" @click="handleSubmit">修改</button>
        </div>
      </div>
    </div>
  </div>
...
const fetchCollectionById = (id: string) => {
  ...
  collection.value = collectionsMap.value.get(decodedId)
}
...
onMounted(() => {
  ...
  if (id) {
    ...
    link.value = collection.value?.link || ''
